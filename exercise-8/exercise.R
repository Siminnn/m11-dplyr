...
pulitzer <- mutate(pulitzer, difference = 
...
#What publication gained the most pulitzer prizes from 1990-2003
most.2003 <- filter(pulitzer, max(Pulitzer.Prize.Winners.and.Finalists..1990.2003) == 
                      Pulitzer.Prize.Winners.and.Finalists..1990.2003) %>% 
  select(Newspaper)